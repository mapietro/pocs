...
# Váriavel global para guardar o conteúdo do documento do usuário
document_content = ""
...
class AgentState(TypedDict):
    messages: Annotated[Sequence[BaseMessage], add_messages] # o add_messages Iundica ao langgrapgh para ir adicionando as mensagens quando retornadas pelos agentes
...
def our_agent(state: AgentState) -> AgentState:
    ...
    - Maybe the user will use Brazilian Portuguese to cretae the document
